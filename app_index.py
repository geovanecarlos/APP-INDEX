...
with tab1:
    def introducao():
        ...
        st.markdown(
            ...
            <blockquote>
            <p><em>Drumond, A.; Nogueira, N. C. O; Reboita, M. S.; Miguel, G. C. (2025). Teleconnection Indices: an updated version for the current climate.<br>In review in CLIVAR Exchange</em></p>
            </blockquote>
            . <br><br>
