...
with tab1:
    def introducao():
        ...
        st.markdown(
            ...
            <p><em>Drumond, A.; Nogueira, N. C. O; Reboita, M. S.; Miguel, G. C. (2025). Teleconnection Indices: an updated version for the current climate. Access: https://www.clivar.org/documents/exchanges-84</em></p>
