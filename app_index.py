...
with tab1:
    def introducao():
        ...
        st.markdown(
            ...
            methodology used in the calculation of the index. If you use this tool, please cite the following article: <em>Drumond, A.; Nogueira, N. C. O; Reboita, M. S.; Miguel, G. C. (2025). Teleconnection Indices: an updated version for the current climate.
            <br>In review in CLIVAR Exchange</em>.<br><br>
